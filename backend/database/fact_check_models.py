...
class FactualVerdict(enum.Enum):
...
class ContentReview(Base):
    ...
    overall_factual_verdict = Column(Enum(FactualVerdict), nullable=True)
    overall_wisdom_verdict = Column(Enum(WisdomVerdict), nullable=True)
...
class FactCheckResult(Base):
    ...
    # Verdict
    verdict = Column(Enum(ClaimVerdict), nullable=False)
...
class WisdomEvaluation(Base):
    ...
    serves_wisdom_or_folly = Column(Enum(WisdomVerdict), nullable=True)
